        ...
        <div className="bg-white dark:bg-[#232e1a] rounded-2xl shadow-sm p-8 md:p-12 border border-white dark:border-white/5 animate-fade-in">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="space-y-6">
              <h2 className="text-xl font-bold text-[#141b0d] dark:text-white border-b border-[#edf3e7] dark:border-white/10 pb-2">Personal Info</h2>
              <div className="space-y-4">
                <div>
                  ...
                  <input 
                    ...
                    className="w-full p-3 rounded-xl bg-[#f7f8f6] dark:bg-[#192210]/50 border border-transparent focus:border-[#73d411] focus:ring-0 text-[#141b0d] dark:text-white transition-all"
                  />
                </div>
                <div>
            ...
            <div className="space-y-6">
              <h2 className="text-xl font-bold text-[#141b0d] dark:text-white border-b border-[#edf3e7] dark:border-white/10 pb-2">Account Stats</h2>
              <div className="grid grid-cols-2 gap-4">
                <div className="p-4 rounded-xl bg-[#f7f8f6] dark:bg-[#192210]/50 border border-transparent">
          ...
          <div className="mt-12 pt-8 border-t border-[#edf3e7] dark:border-white/10 flex justify-end">
